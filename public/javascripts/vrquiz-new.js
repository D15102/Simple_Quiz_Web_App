...
let questions = [
  ...
  {
    "numb": 5,
    "question": "Choose the pair of words that have a relationship most similar to: LIGHT : DARK",
    "answer": "Day : Night",
    "options": [
      "Sun : Moon",
      "Day : Night",
  ...
  if (percentage >= 80) {
    scoreTag += `
      <span>
        ...
        Outstanding verbal reasoning skills!
      </span>
    `;
  } else if (percentage >= 60) {
    scoreTag += `
      <span>
        ...
        Good verbal reasoning abilities!
      </span>
    `;
  } else if (percentage >= 40) {
    scoreTag += `
